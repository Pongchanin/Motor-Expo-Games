...
public class Player1_Controller : NetworkBehaviour
{
    ...
    [SyncVar][SerializeField] protected Joystick joystick;
    [SyncVar][SerializeField] protected JoyButton joybutton;

    [SyncVar][Header("Player Parameter")] 
    ...
    //----------------------
    [SerializeField] [SyncVar] private bool QTE = false;
    [SyncVar] private bool result_pass = true;
    [SyncVar] public bool noquicktime = false;
    [SyncVar] public GameObject bar;
    [SyncVar] public GameObject arrow;
    [SyncVar] public GameObject press;
    [SyncVar] public GameObject sprite;
    [SyncVar] public QTEPressed QTEObj;


    //public GameObject waveSprite;

    [SyncVar] bool quickTimePressed;
    ...
    public void Start()
    {
            ...
            if (isLocalPlayer)
            {
                ...
                QTEObj = GameObject.FindObjectOfType<QTEPressed>();
    ...
    void Update()
    {
        /* if(Application.loadedLevelName == "Level Design Mult" && sceneCheck == false)
         {
             Start();
             sceneCheck = true;
         }*/
        ...
        if (isLocalPlayer)
        {
            ...
            if(QTEObj.isClicked == true)
            {
                quickTimePressed = true;
                QTEObj.isClicked = false;
            }
